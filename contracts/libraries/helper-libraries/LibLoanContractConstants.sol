 ...
 * @author jjgarcia.eth
 * @notice These are a helper libraries to provide internal accessible
 * LoanContractStates constants to a public interface.
 */
...
library LibLoanContractNumbers {
    ...
    uint256 public constant MAX_DEBT_ID = _MAX_DEBT_ID_;
}
