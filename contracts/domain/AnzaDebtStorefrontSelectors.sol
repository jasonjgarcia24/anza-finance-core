...
bytes4 constant _REFINANCE_DEBT_UNPUBLISHED_ = bytes4(
    keccak256("buyRefinance(uint256,uint256,bytes32,bytes)")
);
bytes4 constant _REFINANCE_DEBT_PUBLISHED_ = bytes4(
    keccak256("buyRefinance(uint256,uint256,uint256,bytes32,bytes)")
);
...
bytes4 constant _SPONSOR_DEBT_UNPUBLISHED_ = bytes4(
    keccak256("buySponsorship(uint256,uint256,bytes)")
);
bytes4 constant _SPONSOR_DEBT_PUBLISHED_ = bytes4(
    keccak256("buySponsorship(uint256,uint256,uint256,bytes)")
);
