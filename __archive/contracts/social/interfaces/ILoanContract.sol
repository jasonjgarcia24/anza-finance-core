...
interface ILoanContract is IAccessControl {
    ...
    event LoanStateChanged(
        States.LoanState indexed prevState,
        States.LoanState indexed newState
    );
    ...
    function loanProperties()
        ...
        returns (
            ...
            StateControlUint256.Property memory principal,
            StateControlUint256.Property memory fixedInterestRate,
            StateControlUint256.Property memory duration,
    ...
    /**
     * @dev Borrower sign off on LoanContract.
     */
