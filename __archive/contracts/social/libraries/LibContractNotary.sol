...
import {LibContractGlobals as Globals, LibContractStates as States} from "./LibContractMaster.sol";
...
library LibContractNotary {
    ...
    function signLender_(
        ...
        require(
            msg.value + _accountBalance[msg.sender] >=
                _properties.principal.get(),
            "Paid value and the account balance must be at least the loan principal."
        );
        States.LoanState _prevState = _globals.state;
