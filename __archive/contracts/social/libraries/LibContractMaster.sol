...
library LibContractGlobals {
    ...
    bytes32 internal constant _COLLATERAL_APPROVER_ROLE_ =
        "COLLATERAL_APPROVER";
    ...
    struct Property {
        ...
        StateControlUint256.Property balance;
...
library LibContractStates {
    ...
    function checkActiveState_(address _loanContractAddress) public view {
        ...
        require(
            _state > LibContractStates.LoanState.FUNDED &&
                _state < LibContractStates.LoanState.PAID,
            "Loan state must between FUNDED and PAID exclusively."
        );
    }

    function checkActiveState_(LibContractGlobals.Global storage _globals)
        public
        view
    {
        require(
            _globals.state > LibContractStates.LoanState.FUNDED &&
                _globals.state < LibContractStates.LoanState.PAID,
            "Loan state must between FUNDED and PAID exclusively."
        );
    }
}
...
library LibContractInit {
    ...
    function initializeContract_(
        ...
        _participants.collector = _collector;
        ...
        ac.grantRole(
            LibContractGlobals._COLLATERAL_APPROVER_ROLE_,
            _globals.factory
        );
        ac.grantRole(
            LibContractGlobals._COLLATERAL_APPROVER_ROLE_,
